  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-gray-900">Análise de Marketing</h1>
      ...
      {activeTab === 'seo' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Adicionar Métricas de SEO</h3>
          ...
          {seoMetrics.length > 0 && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Métricas de SEO</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="px-4 py-2 text-left">Palavra-chave</th>
                      <th className="px-4 py-2 text-left">Tráfego</th>
                      <th className="px-4 py-2 text-left">CTR</th>
                      <th className="px-4 py-2 text-left">Posição</th>
                      <th className="px-4 py-2 text-left">Impressões</th>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {seoMetrics.map((metric, index) => (
                      <tr key={index}>
                        <td className="px-4 py-2 font-medium">{metric.keywords}</td>
                        <td className="px-4 py-2">{metric.organicTraffic.toLocaleString()}</td>
                        <td className="px-4 py-2">{metric.clickThroughRate.toFixed(2)}%</td>
                        <td className="px-4 py-2">{metric.averagePosition.toFixed(1)}</td>
                        <td className="px-4 py-2">{metric.impressions.toLocaleString()}</td>
                        <td className="px-4 py-2">{metric.clicks.toLocaleString()}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
      ...
      {activeTab === 'sem' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Adicionar Campanha SEM/PPC</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Nome da Campanha
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Total Conversões</p>
                      <p className="text-xl font-bold text-gray-900">
              ...
              {/* Campaigns Table */}
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Campanhas SEM/PPC</h3>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-4 py-2 text-left">Conversões</th>
                        <th className="px-4 py-2 text-left">Taxa Conv.</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {semMetrics.map((metric, index) => (
                        <tr key={index}>
                          <td className="px-4 py-2 font-medium">{metric.campaignName}</td>
                          <td className="px-4 py-2">R$ {metric.budget.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</td>
                          <td className="px-4 py-2">{metric.impressions.toLocaleString()}</td>
                          <td className="px-4 py-2">{metric.clicks.toLocaleString()}</td>
                          <td className="px-4 py-2">{metric.ctr.toFixed(2)}%</td>
                          <td className="px-4 py-2">R$ {metric.cpc.toFixed(2)}</td>
                          <td className="px-4 py-2">{metric.conversions}</td>
                          <td className="px-4 py-2">{metric.conversionRate.toFixed(2)}%</td>
      ...
      {activeTab === 'social' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Adicionar Métricas de Redes Sociais</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Plataforma
          ...
          {socialMetrics.length > 0 && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Métricas de Redes Sociais</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="px-4 py-2 text-left">Plataforma</th>
                      <th className="px-4 py-2 text-left">Seguidores</th>
                      <th className="px-4 py-2 text-left">Engajamento</th>
                      <th className="px-4 py-2 text-left">Taxa Eng.</th>
                      <th className="px-4 py-2 text-left">Alcance</th>
                      <th className="px-4 py-2 text-left">Taxa Alcance</th>
                      <th className="px-4 py-2 text-left">CTR</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
                    {socialMetrics.map((metric, index) => (
                      <tr key={index}>
                        <td className="px-4 py-2 font-medium capitalize">{metric.platform}</td>
                        <td className="px-4 py-2">{metric.followers.toLocaleString()}</td>
                        <td className="px-4 py-2">{metric.engagement.toLocaleString()}</td>
                        <td className="px-4 py-2">{metric.engagementRate.toFixed(2)}%</td>
                        <td className="px-4 py-2">{metric.reach.toLocaleString()}</td>
                        <td className="px-4 py-2">{metric.reachRate.toFixed(2)}%</td>
                        <td className="px-4 py-2">{metric.ctr.toFixed(2)}%</td>
                      </tr>
                    ))}
                  </tbody>
      ...
      {activeTab === 'email' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Adicionar Campanha de Email</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Nome da Campanha
          ...
          {emailMetrics.length > 0 && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Campanhas de Email Marketing</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="px-4 py-2 text-left">Campanha</th>
                      <th className="px-4 py-2 text-left">Enviados</th>
                      <th className="px-4 py-2 text-left">Taxa Entrega</th>
                      <th className="px-4 py-2 text-left">Taxa Abertura</th>
                      <th className="px-4 py-2 text-left">Taxa Clique</th>
                      <th className="px-4 py-2 text-left">Conversões</th>
                      <th className="px-4 py-2 text-left">Taxa Conv.</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
                    {emailMetrics.map((metric, index) => (
                      <tr key={index}>
                        <td className="px-4 py-2 font-medium">{metric.campaignName}</td>
                        <td className="px-4 py-2">{metric.sent.toLocaleString()}</td>
                        <td className="px-4 py-2">{metric.deliveryRate.toFixed(2)}%</td>
                        <td className="px-4 py-2">{metric.openRate.toFixed(2)}%</td>
                        <td className="px-4 py-2">{metric.clickRate.toFixed(2)}%</td>
                        <td className="px-4 py-2">{metric.conversions}</td>
                        <td className="px-4 py-2">{metric.conversionRate.toFixed(2)}%</td>
                      </tr>
                    ))}
